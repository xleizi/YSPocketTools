...
import static com.lei123.YSPocketTools.utils.SaveAndLoadKt.loadBoolean;
...
public class NotificationService extends Service {
    ...
    public void onCreate() {
        ...
        //cc.ccc(this, getApplication());//检测是否被解包
    ...
    private void initNotification() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            pendingIntent = PendingIntent.getActivity(context, (int) SystemClock.uptimeMillis(),
...
/*            PendingIntent pendingIntent = PendingIntent
        ...
        if (getString(R.string.ResinAndHomecoin).equals(loadString("noticeStyle",getString(R.string.ResinAndHomecoin)))){
            NormalView = new RemoteViews(context.getPackageName(), R.layout.notification_resin_view_homecoin);
        ...
        }else if (getString(R.string.ResinAndExp).equals(loadString("noticeStyle",getString(R.string.ResinAndHomecoin)))){
        ...
        //builder.setCustomBigContentView(NormalView);
        Boolean noticeFix = loadBoolean("noticeFix");
        if(noticeFix){
            builder.setCustomBigContentView(NormalView);
        }else {
        ...
        //builder.setCustomHeadsUpContentView(NormalView);
        //builder.setCustomContentView(NormalView);
