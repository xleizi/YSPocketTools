...
object SignHttp {
    ...
    fun postSignHTTP(uid: String, cookie: String): String {
        ...
        val request: Request = Request.Builder()
            ...
            .addHeader(
                "User",
                "Mozilla/5.0 (Linux; Android 6.0.1; MuMu Build/V417IR; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/52.0.2743.100 Mobile Safari/537.36 miHoYoBBS/2.28.1"
            )
