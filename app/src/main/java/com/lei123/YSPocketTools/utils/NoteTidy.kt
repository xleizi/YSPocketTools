...
object NoteTidy {
    ...
    fun noteExplore(uid: String, data: getResin.DataInfo?): Array<String> {
        ...
        if (exploreInt1 != 0) {
            explore1Aim =
                exploreNamelocal1 + getString(R.string.predict) + TimeCounter.AimTime(exploreInt1) + getString(
                    R.string.accomplish
                )
            explore1Remain =
                getString(R.string.stillNeed) + TimeCounter.NeededTime(exploreInt1) + getString(R.string.accomplish)
        } else {
        ...
        if (exploreInt2 != 0) {
            explore2Aim =
                exploreNamelocal2 + getString(R.string.predict) + TimeCounter.AimTime(exploreInt2) + getString(
                    R.string.accomplish
                )
            explore2Remain =
                getString(R.string.stillNeed) + TimeCounter.NeededTime(exploreInt2) + getString(R.string.accomplish)
        } else {
        ...
        if (exploreInt3 != 0) {
            explore3Aim =
                exploreNamelocal3 + getString(R.string.predict) + TimeCounter.AimTime(exploreInt3) + getString(
                    R.string.accomplish
                )
            explore3Remain =
                getString(R.string.stillNeed) + TimeCounter.NeededTime(exploreInt3) + getString(R.string.accomplish)
        } else {
        ...
        if (exploreInt4 != 0) {
            explore4Aim =
                exploreNamelocal4 + getString(R.string.predict) + TimeCounter.AimTime(exploreInt4) + getString(
                    R.string.accomplish
                )
            explore4Remain =
                getString(R.string.stillNeed) + TimeCounter.NeededTime(exploreInt4) + getString(R.string.accomplish)
        } else {
        ...
        if (exploreInt5 != 0) {
            explore5Aim =
                exploreNamelocal5 + getString(R.string.predict) + TimeCounter.AimTime(exploreInt5) + getString(
                    R.string.accomplish
                )
            explore5Remain =
                getString(R.string.stillNeed) + TimeCounter.NeededTime(exploreInt5) + getString(R.string.accomplish)
        } else {
        ...
        urlSaveToImage(explorePhotoUrlZheng1)
        urlSaveToImage(explorePhotoUrlZheng2)
        urlSaveToImage(explorePhotoUrlZheng3)
        urlSaveToImage(explorePhotoUrlZheng4)
        urlSaveToImage(explorePhotoUrlZheng5)
        urlSaveToImage(explorePhotoUrl1)
        urlSaveToImage(explorePhotoUrl2)
        urlSaveToImage(explorePhotoUrl3)
        urlSaveToImage(explorePhotoUrl4)
        urlSaveToImage(explorePhotoUrl5)
    ...
    fun noteTransfor(uid: String, data: getResin.DataInfo?): Array<String> {
        ...
        transRemainSecond = (transday.toInt() * 86400 + h.toInt() * 3600 + m.toInt() * 60 + s.toInt()).toString()
        ...
        return arrayOf(transday, transRemain, transRemainSecond)
    }
