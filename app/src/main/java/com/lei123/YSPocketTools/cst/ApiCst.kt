...
object ApiCst {
    ...
    const val APP_PACKAGE_NAME_GENSHIN_OS = "com.miHoYo.GenshinImpact"

    const val APP_PACKAGE_NAME_GENSHIN_Bilibili = "com.miHoYo.ys.bilibili"

    const val APP_PACKAGE_NAME_BBS = "com.mihoyo.hyperion"

    const val Notice_Style_HomeCoin = "homecoin1"

    const val Notice_Style_Explore = "explore1"

    const val Notice_Style_OnlyResin = "onlyresin1"
